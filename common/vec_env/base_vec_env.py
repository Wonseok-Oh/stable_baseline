...
class VecEnv(ABC):
    ...
    def __init__(self, num_envs, observation_space, action_space, meta_action_space):
        self.num_envs = num_envs
        self.observation_space = observation_space
        self.action_space = action_space
        self.meta_action_space = meta_action_space
...
class VecEnvWrapper(VecEnv):
    ...
    def __init__(self, venv, observation_space=None, action_space=None):
        ...
        VecEnv.__init__(self, num_envs=venv.num_envs, observation_space=observation_space or venv.observation_space,
                        action_space=action_space or venv.action_space, meta_action_space=meta_action_space or venv.meta_action_space)
